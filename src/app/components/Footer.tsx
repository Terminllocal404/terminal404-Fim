          ...
          <div>
            <div className="flex items-center gap-3 mb-4 group">
              <div className="relative">
                {/* Terminal Icon SVG */}
                <div className="w-10 h-10 bg-gradient-to-br from-[#00E5FF] to-[#0097A7] rounded-lg flex items-center justify-center relative z-10">
                  <svg className="w-6 h-6 text-[#0B0F1A]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
